...
import { Section9 as Section9Type } from '@/types/report'
import { parseISO, isValid, startOfMonth, addMonths, isBefore, isAfter } from 'date-fns'
...
function parseTermin(s: string): Date | null {
  if (!s) return null
  // Try ISO and common Czech formats: DD.MM.YYYY, YYYY-MM-DD
  const formats = [
    s,
...
export default function Section9({ data, date, reportDate }: Props) {
  ...
  return (
    <div>
      <div className="mb-3 flex items-center gap-3">
        ...
        />
        <a
          href={`/api/reports/${date}/export?section=9`}
